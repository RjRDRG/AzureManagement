...
public class AzureManagement {
	...
	static final String MY_PREFIX= "scc2122"; // Add your suffix here
	static final String MY_SUFFIX = "adrqrd"; // Add your suffix here

	public static final String AZURE_COSMOSDB_NAME = MY_PREFIX + MY_SUFFIX;	// Cosmos DB account name
	public static final String AZURE_COSMOSDB_DATABASE = MY_PREFIX + "db" + MY_SUFFIX;	// Cosmos DB database name
	public static final String[] BLOB_CONTAINERS = { "images" };	// Containers to add to the blob storage
	...
	static final String[] AZURE_APP_NAME = Arrays.stream(REGIONS).map(reg -> MY_PREFIX + "-app-" + reg.name() + "-" + MY_SUFFIX)
			.toArray(String[]::new);
	...
	static final String[] AZURE_FUNCTIONS_NAME = Arrays.stream(REGIONS).map(reg -> MY_PREFIX + "fun" + reg.name() + MY_SUFFIX)
			.toArray(String[]::new);
